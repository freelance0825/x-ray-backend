...
public class PatientController {
    ...
    public ResponseEntity<PatientResponseDto> addPatient (@RequestParam("name") String name,
        ...
        PatientResponseDto savedUser = patientService.savePatientWithImage(name, address, gender , email , state, age, dob, phoneNumber, image);
        return ResponseEntity.ok(savedUser);
    }


    @PutMapping("/patients/{id}")
    public ResponseEntity<PatientResponseDto> updatePatient(@PathVariable Long id, @RequestParam("name") String name,
                                                            @RequestParam("address") String address,
                                                            @RequestParam("gender") String gender,
                                                            @RequestParam("email") String email,
                                                            @RequestParam("state") String state,
        ...
        try {
            PatientResponseDto updatedUser = patientService.updateUser(id, name, address, gender , email , state, age, dob, phoneNumber, image);
